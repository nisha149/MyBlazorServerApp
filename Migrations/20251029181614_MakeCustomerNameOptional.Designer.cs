...
namespace MyBlazorServerApp.Migrations
{
    ...
    [Migration("20251029181614_MakeCustomerNameOptional")]
    partial class MakeCustomerNameOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("CustomerCodeSeq", "dbo");
            ...
            modelBuilder.Entity("MyBlazorServerApp.Models.SalesInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyBlazorServerApp.Models.SalesInvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyBlazorServerApp.Models.PurchaseInvoice", b =>
                {
                    b.HasOne("MyBlazorServerApp.Models.Supplier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyBlazorServerApp.Models.SalesInvoiceItem", b =>
                {
                    b.HasOne("MyBlazorServerApp.Models.SalesInvoice", null)
                        .WithMany("Items")
